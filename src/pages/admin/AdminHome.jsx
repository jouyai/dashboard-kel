        ...
        {cards.map((card) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div
                className={`p-4 bg-gradient-to-br ${card.color} rounded-2xl shadow-lg`}
              >
            ...
            <Link
              to={card.link}
              className="mt-6 flex items-center text-[10px] font-bold text-blue-400 gap-1 hover:text-blue-300 transition"
            >
